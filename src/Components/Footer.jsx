...
export default function Footer() {
  return (
    <>
      <div className="fixed bottom-0 w-full max-w-[1900px]  px-4">
        <div className=" flex flex-col-reverse  w-full lg:flex-row lg:flex lg:mb-10 lg:justify-between lg:items-center">
          <div className="relative z-10   flex flex-col items-start">
            <div className=" flex justify-between flex-col h-[200px] ">
          ...
          <div className=" flex flex-col gap-30 lg:flex-row ">
            <div className="flex flex-col gap-4">
              <h1 className="dark:text-[var(--primary)] font-bold text-[#181818] text-xl mb-4">
                Links
              </h1>
        ...
        <div className=" fixed bottom-0 max-w-[900px]  left-1/2 -translate-x-1/2 w-full h-[180px] bg-gradient-to-l from-blue-500/40 via-purple-500/40 to-orange-500 blur-[124px]" />
      </div>
    </>
  );
}
