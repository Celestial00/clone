...
export default function Navbar() {
  return (
    <div className=" flex items-center justify-between  bg-[#18181D4D] w-full h-[60px] mt-10 ">
      <div className=" flex py-2 px-2 gap-8">
        ...
        <div className="flex  gap-8">
          <Link to="/">
            <p className="text-[var(--secondary)]   text-[16px] ">About </p>
          </Link>
          <Link to="/">
            <p className="text-[var(--secondary)] text-[16px] ">Work </p>
          </Link>
          <Link to="/">
            <p className="text-[var(--secondary)] text-[16px] ">Notebook </p>
          </Link>
          <Link to="/">
            <p className="text-[var(--secondary)] text-[16px] ">Contact </p>
          </Link>
          <div>
            <p className="text-[var(--secondary)] text-[16px] ">More </p>
          </div>
        </div>
      </div>
