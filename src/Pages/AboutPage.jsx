export default function AboutPage() {
  return (
    <div className=" my-20 px-6 py-20">
      {/* Page Heading */}
      <div className="mb-16">
        <h1 className="lg:text-8xl text-5xl font-bold text-black dark:text-white">
          A little bit about me
        </h1>
        <p className="text-gray-500 mt-2 text-lg">Who I am and what I do.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
        ...
        <div className="md:col-span-2 space-y-10">
          <div>
            <h2 className="text-sm md:text-base font-semibold uppercase text-black dark:text-gray-500 tracking-widest mb-2">
              WHO I AM
            </h2>
        ...
        <div className="flex flex-col items-center gap-6 mt-6 w-full">
          {/* Profile Card */}
          <div className="w-64 h-80 bg-[#141414] rounded-xl border border-[#1f1f1f] overflow-hidden flex items-center justify-center">
            <img
              src="/dark.png"
              alt="Profile"
          ...
          {/* Get in Touch Button */}
          <button className="bg-[#1a1a1a] text-gray-200 px-6 py-2 rounded-lg flex items-center gap-2 border border-[#2a2a2a] hover:bg-[#2a2a2a] transition">
            <svg
